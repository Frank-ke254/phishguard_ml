...
if not SECRET_KEY:
    raise ValueError("DJANGO_SECRET_KEY is not set. Add it to backend/.env.")
...
ASGI_APPLICATION = "phishguard.asgi.application"
...
# Security defaults for production-like deployments.
